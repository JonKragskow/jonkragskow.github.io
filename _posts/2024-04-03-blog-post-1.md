...
The oscillator strength $f$ is defined as the ratio of $A_\mathrm{e}$ for a given band to the (constant) value of $A_\mathrm{e}$ for a harmonically oscillating electron.

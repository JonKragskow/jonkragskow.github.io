...
So in short: **The g-tensor is a compact method for describing the effect of a magnetic field on a two level system (or more specifically a (pseudo) spin‑1/2 doublet) and contains a set of values $g_{\alpha, \beta}$.**
